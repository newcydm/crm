...
<script type="text/javascript">
	...
	$(function(){
		$("#activityList").delegate(".activityId","click",function () {
			$("#activity").val($(this).attr("data-name"));
...
<body>
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" id="activityId" class="form-control" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询">
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form id="tranForm" >
			...
			<input type="hidden" name="id" id="clueId" value="${param.id}"/>
			<input type="hidden" name="activityId" id="aId" />
	...
	<div id="operation" style="position: relative; left: 40px; height: 35px; top: 100px;">
		<input class="btn btn-primary" type="button" id="transition" value="转换">
		&nbsp;&nbsp;&nbsp;&nbsp;
		<input class="btn btn-default" type="button" value="取消" id="cancel">
	</div>
</body>
