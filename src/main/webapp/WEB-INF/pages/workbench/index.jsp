...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#btuUpdateUserPwd").click(function () {
			//判断新密码是否相等
			if($("#confirmPwd").val()!=$("#newPwd").val()){
				alert("请重新输入");
				return;
			}
			var ypassword=$.md5($("#oldPwd").val())
			var password=$.md5($("#confirmPwd").val());

			$.ajax({
				url:"../settings/qx/user/updatePwd",
				type:"post",
				data:{ypassword:ypassword,password:password},
		...
		<div class="modal-dialog" role="document" style="width: 70%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary"  id="btuUpdateUserPwd">更新</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
		...
		<div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
			...
			<ul id="no1" class="nav nav-pills nav-stacked">
				<li class="liClass"><a href="main/index" target="workareaFrame"><span class="glyphicon glyphicon-home"></span> 工作台</a></li>
				...
				<li class="liClass"><a href="contacts/index" target="workareaFrame"><span class="glyphicon glyphicon-earphone"></span> 联系人</a></li>
				<li class="liClass"><a href="transaction/index" target="workareaFrame"><span class="glyphicon glyphicon-usd"></span> 交易（商机）</a></li>
				<li class="liClass"><a href="visit/index" target="workareaFrame"><span class="glyphicon glyphicon-phone-alt"></span> 售后回访</a></li>
				<li class="liClass">
