...
<script type="text/javascript">
	...
	var phase='${tran.stage}';
	
	$(function(){
		$.ajax({
			url:"api/queryDicValueByType",
		...
		-----------
					...
					if(i<index){
							html+=`
						<span class="glyphicon glyphicon-record mystage" data-toggle="popover" data-placement="bottom" data-content="${'${item.value}'}" style="color: #90F790;"></span>-----------
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<div style="float:left" id="dicValueList">
